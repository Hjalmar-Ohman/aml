...
Repeat the previous step using the five data points in the table, but this time with hyperparameters $\sigma_f = 1$ and $\ell = 1$. Compare the results.
...
Gives a smoother graph since we increased the scale of the kernel, causing points further away to affect the given point more.
...
plot(time, temp)
lines(time, day_meanPred, col="red", lwd = 2)
lines(time, day_meanPred+1.96*predict(GPfit,day, type="sdeviation"),col="blue")
lines(time, day_meanPred-1.96*predict(GPfit,day, type="sdeviation"),col="blue")
```

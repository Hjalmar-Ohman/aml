...
GPfit = gausspr(time,temp, kernel = SquaredExpKernel(sigmaF = 20, ell = 100), var = sigmaNoise, scaled = FALSE, variance.model = TRUE)
...
```{r}
sigmaNoise = var(polyFit$residuals)
GPfit = gausspr(day,temp, kernel = SquaredExpKernel(sigmaF = 20, ell = 100), var = sigmaNoise, scaled = FALSE, variance.model = TRUE)
...
GPfit = gausspr(time,temp, kernel = ExtendedSquaredExpKernel(sigmaF = 20, ell1 = 1, ell2 = 100, d = 365 ), var = sigmaNoise, scaled = FALSE, variance.model = TRUE)

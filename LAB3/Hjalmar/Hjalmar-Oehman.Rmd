...
- Answer the following questions:
  ...
  2. Is the final greedy policy (after 10000 episodes) optimal for all states? Why or why not?
  3. Do the learned values in the Q-table reflect the existence of multiple paths to the positive reward?
...
## 3.2
Environment A:
- Set up a 5x7 grid with rewards at specific states and analyze the agent's learning process by visualizing its Q-table and policies at different stages of learning.

...
A: No. For example, the action policy for state (3, 1) is to go left, but the optimal action is right. This is due to the agent not having had the chance of exploring this state enough times.
...
A: No, it always tries to go above.This is due to the agent start_state being closer to the top. We could either enforce a greater epsilon, or change start_state to be closer to the middle (e.g (1, 3))
